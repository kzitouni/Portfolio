    ...
    return (
        <div className="About_Cont" id="About">
            ...
            <ScrollAnimation animateIn='fadeInRight' animateOnce='true'>
                <p className="About_Text">I'm a software engineer based in New York.  I am passionate about building remarkable websites and web apps that provide an exceptional user interface.
</p>
</ScrollAnimation>
